...
const Lightbox = ({ images, open, closeLightbox }) => {
  if (open) {
    return (
      <div className="absolute z-50 bg-black/60 backdrop-blur-lg	 w-full h-full ease-in-out duration-500 inline-flex items-center justify-center">
        <div className="block relative aspect	">
